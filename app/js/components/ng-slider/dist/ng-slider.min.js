...
function(a) {
    "use strict";
    a.module("ngSlider").factory("slider", ["sliderPointer", "sliderConstants", "sliderUtils",
        function(b, c, d) {
            function e() {
            ...
            return e.prototype.init = function(b, d, e) {
                ...
                if (!this.settings.single && !this.settings.vertical) {
                    ...
                    o + 10 < k.o[0].offsetWidth + l.o[0].offsetWidth ? (f.o.css(this.css.hidden), f.value.html(this.nice(g.value.origin)), e = (g.value.prc - e) / 2 + e, g.value.prc != a.value.prc && (d.value.html(this.nice(this.o.pointers[0].value.origin) + "&nbsp;&ndash;&nbsp;" + this.nice(this.o.pointers[1].value.origin)), i.label = d.o[0].offsetWidth, i.border = e * p / 100)) : (f.value.html(this.nice(g.value.origin)), f.o.css(this.css.visible))
                }
                i = b(d, i, e);
...
function(a) {
    ...
    a.module("ngSlider").run(["$templateCache",
        function(a) {
            a.put("ng-slider/slider-bar.tmpl.html", '<span ng-class="mainSliderClass" id="{{sliderTmplId}}"><table><tr><td><div class="jslider-bg"><i class="l"></i><i class="r"></i><i class="v"></i><i class="p"></i><i class="s"></i><i class="s"></i><i class="f"></i></div><div class="jslider-pointer"></div><div class="jslider-pointer jslider-pointer-to"></div><div class="jslider-label"><span>{{from}}</span>{{options.dimension}}</div><div class="jslider-label jslider-label-to"><span>{{to}}</span>{{options.dimension}}</div><div class="jslider-value"><span></span>{{options.dimension}}</div><div class="jslider-value jslider-value-to"><span></span>{{options.dimension}}</div><div class="jslider-scale" id="{{sliderScaleDivTmplId}}"></div></td></tr></table></span>')
        }
    ])
}(window.angular);
